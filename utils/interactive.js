$.extend(KhanUtil, {
	...
	addMovableCircle: function(options,coords) {
        // The state object that gets returned
        var movablePoint = $.extend(true, {
            graph: KhanUtil.currentGraph,
        ...
        movablePoint.normalStyle.scale = 1;
        movablePoint.highlightStyle.scale = 1.2;
    ...
    //         smartPoints
    addMovableLineSegmentRule: function(options) {
            ...
            $(lineSegment.mouseTarget[0]).bind("vmousedown vmouseover vmouseout", function(event) {
                if (event.type === "vmouseover") {
                    ...
                    $(document).bind("vmousemove vmouseup", function(event) {
                        ...
                        mouseX = Math.max(offsetLeft + 0, Math.min(graph.xpixels - 0 - offsetRight, mouseX));
                        mouseY = Math.max(offsetTop + 0, Math.min(graph.ypixels - 0 - offsetBottom, mouseY));
